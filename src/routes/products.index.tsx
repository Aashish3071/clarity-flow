  ...
  head: () => ({
    meta: [
      { title: "Products — CRM, ERP & E-commerce | Clearwork" },
      {
        name: "description",
        content:
          "Three connected products that share one system of record: CRM, ERP and E-commerce.",
      },
      { property: "og:title", content: "Products — CRM, ERP & E-commerce" },
      {
        property: "og:description",
        content: "Choose CRM, ERP or E-commerce — or run them together on one connected platform.",
      },
  ...
  const items = [
    {
      ...
      title: "CRM",
      to: "/products/crm",
      body: "Leads, customers, quotations and long-term customer relationships in one place.",
    },
    {
      icon: Package,
      title: "ERP",
      to: "/products/erp",
      body: "Inventory, purchasing, finance, operations and projects through one connected system.",
    },
    {
      icon: ShoppingCart,
      title: "E-commerce",
      to: "/products/ecommerce",
      body: "Products, online orders, customers and inventory managed from one platform.",
    },
  ];
  return (
        ...
        <div className="container-page grid gap-6 md:grid-cols-3">
          {items.map((p) => (
            <Link
              key={p.title}
              to={p.to}
              className="group rounded-2xl border border-border bg-card p-7 shadow-soft transition hover:-translate-y-0.5 hover:shadow-card"
            >
