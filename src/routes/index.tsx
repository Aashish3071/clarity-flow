  ...
  head: () => ({
    meta: [
      { title: "Clearwork — Business software built around how your business works" },
      {
        name: "description",
        content:
          "CRM, ERP and E-commerce solutions tailored, deployed and supported for growing companies. Schedule a demo to see it applied to your business.",
      },
      { property: "og:title", content: "Clearwork — Business software built around your business" },
      {
        property: "og:description",
        content: "CRM, ERP and E-commerce for growing companies. Tailored, deployed, supported.",
      },
      ...
      <div className="container-page grid gap-12 pt-12 pb-16 md:grid-cols-12 md:gap-10 md:pb-24 md:pt-20 lg:pt-24">
        <div className="md:col-span-6 md:pr-4 lg:col-span-6">
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-ink-soft md:text-lg">
            Bring your customers, sales, operations, inventory and finance into one connected system
            designed to simplify everyday work and support business growth.
          </p>
  ...
  const items = [
    {
      ...
      extra:
        "Smart CRM helps teams stay organised by suggesting follow-ups, surfacing relevant information and reducing repetitive work.",
    },
    {
      icon: Package,
      title: "ERP",
  ...
  return (
    <section id="products" className="py-16 md:py-24">
      <div className="container-page">
        <SectionHeader
          eyebrow="Products"
          title="Three connected products. One system of record."
          intro="Adopt what you need today. Add what you need next — without switching platforms."
        />
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {items.map((p) => (
            <div
              key={p.title}
              className="group flex flex-col rounded-2xl border border-border bg-card p-6 shadow-soft transition hover:-translate-y-0.5 hover:shadow-card"
            >
              ...
              <Link
                to={p.to}
                className="mt-6 inline-flex items-center gap-1.5 text-sm font-medium text-[color:var(--brand)] hover:opacity-80"
              >
                Learn more{" "}
...
function WhyChoose() {
  const items = [
    {
      icon: Timer,
      t: "Spend less time updating records",
      d: "Information flows between customers, orders and finance without duplicate entry.",
    },
    {
      icon: Database,
      t: "Work from one reliable source",
      d: "Teams stop hunting through spreadsheets, folders and inboxes for the current version.",
    },
    {
      icon: Eye,
      t: "Improve visibility across teams",
      d: "Everyone sees the same status, from first enquiry through delivery and invoicing.",
    },
    {
      icon: Zap,
      t: "Reduce repetitive administration",
      d: "Approvals, reminders and reports move on their own instead of by hand.",
    },
    {
      icon: GitBranch,
      t: "Support faster business decisions",
      d: "Real numbers are ready when you need them — not two days later.",
    },
    {
      icon: Layers,
      t: "Grow without adding complexity",
      d: "New branches, staff and products fit into the system already in place.",
    },
  ];
  return (
    <section className="border-y border-border bg-surface py-16 md:py-24">
      <div className="container-page">
        <SectionHeader
          eyebrow="Why businesses choose this"
          title="Business outcomes, not software features."
        />
      ...
      <div className="container-page grid gap-12 md:grid-cols-12 md:items-center">
        <div className="md:col-span-6">
          ...
          <p className="mt-4 max-w-xl text-base leading-relaxed text-ink-soft">
            Smart CRM works in the background of your normal workflow — offering useful suggestions
            and context without asking your team to change how they work.
          </p>
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-card">
            ...
            <ul className="mt-4 space-y-2">
              {[
                ...
                <li
                  key={s}
                  className="flex items-start gap-3 rounded-lg border border-border bg-background p-3 text-sm text-ink"
                >
  ...
  const list = [
    {
      icon: HardHat,
      t: "Construction",
      d: "Coordinate projects, subcontractors and site operations.",
    },
    ...
    { icon: Store, t: "Retail", d: "Unify stores, online orders and stock in real time." },
    {
      icon: Truck,
      t: "Trading",
      d: "Manage suppliers, purchasing and distribution from one place.",
    },
    {
      icon: Stethoscope,
      t: "Healthcare",
      d: "Organise patients, appointments and clinic operations.",
    },
    {
      icon: Briefcase,
      t: "Professional Services",
      d: "Deliver client work, timesheets and billing without friction.",
    },
  ];
  return (
    <section className="border-y border-border bg-surface py-16 md:py-24">
      <div className="container-page">
        ...
        <div className="mt-10 -mx-5 flex snap-x snap-mandatory gap-3 overflow-x-auto px-5 pb-2 md:mx-0 md:grid md:grid-cols-3 md:overflow-visible md:px-0">
          {list.map(({ icon: Icon, t, d }) => (
            <div
              key={t}
              className="snap-start shrink-0 basis-[85%] rounded-xl border border-border bg-card p-5 md:basis-auto"
            >
  ...
  const steps = [
    {
      icon: Search,
      t: "Discover",
      d: "Understand how the business runs today — teams, workflows and priorities.",
    },
    {
      icon: Sliders,
      t: "Configure",
      d: "Tailor the solution around existing workflows, not the other way around.",
    },
    {
      icon: Database,
      t: "Prepare",
      d: "Import data, connect systems and validate everything before go-live.",
    },
    {
      icon: Rocket,
      t: "Launch",
      d: "Go live with confidence and a clear plan for the first weeks.",
    },
    {
      icon: LifeBuoy,
      t: "Support",
      d: "Continue improving after implementation as the business changes.",
    },
  ];
  return (
    <section className="py-16 md:py-24">
        ...
        <ol className="mt-12 grid gap-4 md:grid-cols-5">
          {steps.map((s, i) => (
            <li key={s.t} className="relative rounded-xl border border-border bg-card p-5">
              <span className="text-[11px] font-semibold uppercase tracking-wider text-[color:var(--brand)]">
      ...
      items={[
        {
          ...
          a: "Most rollouts move from first conversation to a working system within a few weeks. Scope, data and integration needs shape the timeline.",
        },
        {
          q: "Can it work with our existing processes?",
          a: "Yes. Discovery starts with your current workflows, and the system is configured around them rather than replacing them wholesale.",
        },
        {
          q: "Can additional functionality be added later?",
          a: "Yes. Most companies start with a focused area and expand into other modules once teams are comfortable.",
        },
        {
          q: "How much training is required?",
          a: "Minimal. Interfaces are kept familiar and short walkthroughs cover the day-to-day for each role.",
        },
        {
          q: "What support is available after launch?",
          a: "Ongoing support is included — adjustments, guidance and improvements as the business changes.",
        },
      ]}
    />
  );
