  ...
  head: () => ({
    meta: [
      { title: "Contact — Clearwork" },
      {
        name: "description",
        content:
          "Talk to us about CRM, ERP or E-commerce for your business. We reply within one business day.",
      },
      { property: "og:title", content: "Contact Clearwork" },
      {
        property: "og:description",
        content: "Get in touch about CRM, ERP or E-commerce for your business.",
      },
          ...
          <div className="md:col-span-4">
            ...
            <ul className="mt-6 space-y-4 text-sm text-ink-soft">
              <li className="flex items-start gap-3">
                <Mail className="mt-0.5 h-4 w-4 text-[color:var(--brand)]" /> hello@clearwork.co
              </li>
              <li className="flex items-start gap-3">
                <Phone className="mt-0.5 h-4 w-4 text-[color:var(--brand)]" /> +971 4 000 0000
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="mt-0.5 h-4 w-4 text-[color:var(--brand)]" /> Dubai · Riyadh ·
                Remote
              </li>
            </ul>
